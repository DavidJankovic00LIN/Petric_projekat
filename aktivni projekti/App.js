...
function App() {
      ...
      <main className="flex flex-col items-center justify-center">
        ...
        <section className="bg-gray-100 py-20 px-4 text-center">
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
           Ovde ide tekst o tekucim projektima, metnuti neki hero text ili tako neki kurac palac
          </p>
        </section>

  
      
     {/* Sekcija sa projektima */}
  ...
  <div className="relative w-full ">
    ...
    />
    <div className="absolute bottom-4 left-4 bg-white bg-opacity-90 p-3 max-w-xs">
      <h3 className="text-lg font-bold text-gray-800">PROJEKAT 1</h3>
    </div>
  </div>
  ...
  <div className="relative w-full ">
    ...
    />
    <div className="absolute bottom-4 left-4 bg-white bg-opacity-90 p-3 max-w-xs">
      <h3 className="text-lg font-bold text-gray-800">PROJEKAT 2</h3>
    </div>
  </div>
  ...
  <div className="relative w-full ">
    ...
    />
    <div className="absolute bottom-4 left-4 bg-white bg-opacity-90 p-3 max-w-xs">
      <h3 className="text-lg font-bold text-gray-800">PROJEKAT 3</h3>
    </div>
  </div>
</section>
